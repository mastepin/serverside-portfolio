...
export default class SkillSection extends Component {
	...
	render() {
		return (
			<div className={`section section-container p-5 ${this.props.isPages ? '' : 'section-bg-gray'} `}>
				<div className="container">
							...
							<div className="myskill">
								<div className="row">
									{this.state.skills.map(skill => (
										<div className="col-md-3 col-sm-12 mb-5" key={skill.skillName}>
											<div className="skillPanel">
												<div className="row">
													...
													<div className="offset-md-2 col-md-8 text-center">
														<Progress value={skill.percentage} className="skillProgress"/>
													</div>
													<div className="col-md-12">
					...
					<div className="row mb-3">
						<div className={`col-md-12 text-center ${this.props.isPages ? 'hidden' : 'show'} `}>
							<Link prefetch href="/skills"><a className="btn ghost-button ghost-teal">View More About My Skill</a></Link>
						</div>
					</div>
				</div>
			</div>
